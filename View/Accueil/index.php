					...
					<ul>
						...
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1500">
							...
							<div class="tp-caption medium_bold_orange skewfromleftshort customout start font300"
								...
								data-endeasing="Power4.easeIn"
								data-captionhidden="off"
								style="z-index: 13;">L'Envi <strong>Le courage</strong>
							</div>
						...
						<li data-transition="3dcurtain-vertical" data-slotamount="14"  data-masterspeed="300" data-delay="10000">
							...
							<div class="tp-caption sft large_bold_grey"
								...
								data-speed="300"
								data-start="1200"
								data-easing="easeOutExpo">VIVONS
							</div>
							...
							<div class="tp-caption lfb thinheadline_dark"
								...
								data-speed="300"
								data-start="1600"
								data-easing="easeOutExpo">Vous permettre une bonne intégration
							</div>
						...
						<li data-transition="incube-horizontal" data-slotamount="5" data-masterspeed="700" >
							...
							<div class="tp-caption large_text sft"
								...
								data-start="1000"
								data-endspeed="500"
								data-easing="easeOutBack"><h1>SHARME CANADA</h1>
							</div>
							...
							<div class="tp-caption large_text sft"
								...
								data-start="1700"
								data-endspeed="500"
								data-easing="easeOutBack"><h2>  Nous y sommes profitons <br/>pleinement des joies du CANADA</h2>
							</div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-7 animation_fade_in">
							<h2>Que fait <strong>Sharme Canada</strong></h2>
							<p class="lead">
								Sharme est .... vous permet...
							</p>
							<p>
						...
						<div class="col-md-5 animation_fade_in">
							<img class="visible-md visible-lg img-responsive pull-right" src="assets/images/demo/desktop2.png" alt="" />
						</div>-->
					</div>
				</div>
			</section>
